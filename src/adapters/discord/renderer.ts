...
import { DISCORD_CONTENT_CAPABILITIES } from "../../core/content/capabilities.js";
import { ButtonComponent, DISCORD_BUTTON_CAPABILITIES } from "../../core/components/button.js";

export class DiscordMessageRenderer
  implements MessageRenderer<"discord">
{
