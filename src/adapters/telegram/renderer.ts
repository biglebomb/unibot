...
import { TELEGRAM_CONTENT_CAPABILITIES } from "core/content/capabilities"
import {
  ButtonComponent,
  TELEGRAM_BUTTON_CAPABILITIES,
} from "core/components/button"

export class TelegramMessageRenderer implements MessageRenderer<"telegram"> {
